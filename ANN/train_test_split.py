...
FEATURE_VECTORS_PATH = '../Data/feature_vectors_PCA_0.99_2601d.csv'

feature_vectors = pd.read_csv(FEATURE_VECTORS_PATH, index_col=0)

# SAVE SHUFFLED TRAINING, TEST AND VALIDATION DATA
# pylint: disable=unbalanced-tuple-unpacking
feature_vectors_training, feature_vectors_test = np.split(feature_vectors.sample(frac=1), [int(.85 * len(feature_vectors))])
